        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h5>Pesanan anda sudah sukses di check out selanjutnya untuk pembayaran silahkan transfer di rekening <strong>Bank BRI Nomor Rekening : 83945-947284-321</strong> dengan nominal : <strong>Rp.{{ number_format($pesanan->jumlah_harga+$pesanan->kode) }}</strong></h5>
                </div>
            </div>
            <div class="card mt-2">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $no++ }}</td>
                                <td>
                                    <img src="{{ url('uploads') }}/{{ $pesanan_detail->barang->gambar }}" width="100" alt="{{ $pesanan_detail->barang->nama_barang }}">
                                </td>
